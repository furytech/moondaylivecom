...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const upsert = {
      ...
      facebook_post: facebook_post || null,
      pinterest_post: pinterest_post || null,
      twitter_post: twitter_post || null,
      threads_post: threads_post || null,
      instagram_post: instagram_post || null,

...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-x-hidden">
      ...
      {/* Hero Section */}
      <main className="flex-1 flex flex-col relative z-10 pt-16 md:pt-[4.5rem]">
        <section className="flex flex-col items-center justify-center px-6 md:px-8 pt-6 pb-16 relative">
          {/* Soft lilac glow */}
          <div

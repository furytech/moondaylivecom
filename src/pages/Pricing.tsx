      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          ...
          <GlassmorphismCard className="animate-fade-up stagger-2 flex flex-col relative border-primary/40 mt-4 md:mt-0">
            <span className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1.5 bg-primary text-primary-foreground font-display text-[10px] tracking-[0.15em] uppercase rounded-full whitespace-nowrap z-20 shadow-lg">
              Most Popular
            </span>

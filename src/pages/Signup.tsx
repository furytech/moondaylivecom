...
const Signup = () => {
  ...
  return (
    <PageLayout showFooter={false}>
      {/* Title */}
      <h1 className="font-display text-3xl md:text-4xl lg:text-5xl text-gold-gradient text-center mb-2 tracking-wider animate-fade-up">
        Your Celestial Details
      </h1>

      {/* Subtitle */}
      <p className="font-serif text-base md:text-lg text-cream-muted text-center max-w-md mb-10 leading-relaxed animate-fade-up stagger-1">
        Enter your birth date and email to unlock the secrets of your Moon sign
      </p>

      {/* Form */}
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-6 animate-fade-up stagger-2">
        {/* Birthday Picker */}

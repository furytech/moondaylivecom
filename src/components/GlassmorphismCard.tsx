...
const GlassmorphismCard = ({
  ...
  const glowStyles = {
    gold: "shadow-[0_0_60px_-15px_hsl(239,84%,67%,0.25)] border-[hsl(var(--reveal-strong)/0.8)] hover:border-[hsl(var(--reveal-strong)] hover:shadow-[0_0_80px_-15px_hsl(239,84%,67%,0.35)]",

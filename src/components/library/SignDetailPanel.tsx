        ...
        <ScrollArea className="h-[90vh]">
          <div className="p-6 md:p-10">
            ...
            <div className="text-center mb-8 md:mb-12">
              <span className="text-5xl md:text-7xl text-primary/80 font-display block mb-4">
                {content.symbol}
              </span>
              <h2 className="font-display text-3xl md:text-5xl text-gold-gradient tracking-[0.15em] uppercase mb-3">
                {content.sign}
              </h2>
              ...
              <TabsList className="w-full flex flex-wrap justify-center gap-2 bg-transparent mb-8">
                {[
                  ...
                  <TabsTrigger
                    ...
                    value={tab.value}
                    className={cn(
                      "relative px-4 py-2 font-display text-xs md:text-sm tracking-[0.15em] uppercase",
